...
/*
    ...
    * This class can be annotated with @RestControllerAdvice to handle exceptions for REST controllers.
    * It provides methods to handle specific exceptions and return appropriate responses.
 */
